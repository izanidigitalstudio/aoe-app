...
export const SA_CONFERENCES: Conference[] = [
  ...
  },
  {
    ...
    contactEmail: 'info@digitransformationsummit.com',
    speakerEmail: 'speakers@digitransformationsummit.com',
    attendees: '200+',
    icon: 'trending-up',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@aibc.world',
    speakerEmail: 'speakers@aibc.world',
    attendees: '5,000+',
    icon: 'link',
  },
  {
    ...
    contactEmail: 'info@itweb.co.za',
    speakerEmail: 'speakers@itweb.co.za',
    attendees: '500+',
    icon: 'cpu',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@sacair.org.za',
    speakerEmail: 'speakers@sacair.org.za',
    attendees: '300+',
    icon: 'cpu',
  },
  {
    ...
    contactEmail: 'info@connected-africa.com',
    speakerEmail: 'speakers@connected-africa.com',
    attendees: '1,000+',
    icon: 'wifi',
  },
  {
    ...
    contactEmail: 'info@wearevuka.com',
    speakerEmail: 'speakers@wearevuka.com',
    attendees: '3,000+',
    icon: 'shopping-cart',
  },
  {
    ...
    contactEmail: 'info@cloudconference.co.za',
    speakerEmail: 'speakers@cloudconference.co.za',
    attendees: '500+',
    icon: 'cloud',
  },
  ...
  // --- CYBERSECURITY ---
  {
    ...
    contactEmail: 'info@exito-e.com',
    speakerEmail: 'speakers@exito-e.com',
    attendees: '200+',
    icon: 'shield',
  },
  {
    ...
    contactEmail: 'info@tci-sa.co.za',
    speakerEmail: 'speakers@tci-sa.co.za',
    attendees: '100+',
    icon: 'lock',
  },
  {
    ...
    contactEmail: 'info@globalriskcommunity.com',
    speakerEmail: 'speakers@globalriskcommunity.com',
    attendees: '250+',
    icon: 'alert-triangle',
  },
  ...
  // --- INVESTMENT ---
  {
    ...
    location: 'Sandton Convention Centre, Johannesburg',
    country: 'South Africa',
    description: "The 6th South Africa Investment Conference, part of President Ramaphosa's drive to attract R2 trillion in new investment over the next five years. Building on R1.56 trillion raised in the first cycle. Connecting local and global investors across mining, manufacturing, agriculture, digital economy and infrastructure. Over 31 countries represented.",
    website: 'https://www.sainvestmentconference.co.za',
    contactEmail: 'info@sainvestmentconference.co.za',
    speakerEmail: 'speakers@sainvestmentconference.co.za',
    attendees: '1,250+',
    icon: 'dollar-sign',
    delegateInfo: {
      delegateFee: 'By Invitation / Registration',
      delegateTypes: ['Government', 'Corporate', 'International Investor', 'SMME'],
      includes: ['Full-day conference access', 'Investment showcase', 'Networking sessions', 'Exhibition access'],
    },
  },
  {
    name: 'Gauteng Investment Conference 2026',
    focus: 'Investment',
    date: 'Apr 9, 2026',
    location: 'Sandton Convention Centre, Johannesburg',
    country: 'South Africa',
    description: "Building on R312.5 billion in pledges from 2025 (28% already converted to active projects). The Gauteng Investment Conference 2026 convenes government, corporates, SMMEs and investors to unlock opportunities in Africa's economic powerhouse province. Targeting R200 billion in new investment across manufacturing, technology, green economy and infrastructure development.",
    website: 'https://gic.ggda.co.za',
    contactEmail: 'info@ggda.co.za',
    speakerEmail: 'speakers@ggda.co.za',
    attendees: '1,000+',
    icon: 'dollar-sign',
    delegateInfo: {
      delegateFee: 'By Registration',
      earlyBirdDeadline: 'Apr 8, 2026',
      delegateTypes: ['Investor', 'Corporate', 'Government', 'SMME', 'International Delegate'],
      includes: ['Conference access', 'Investment showcases', 'Networking', 'Pledge announcements'],
    },
  },
  {
    ...
    contactEmail: 'info@informaconnect.com',
    speakerEmail: 'speakers@informaconnect.com',
    attendees: '1,200+',
    icon: 'bar-chart-2',
  },
  {
    ...
    contactEmail: 'info@savca.co.za',
    speakerEmail: 'speakers@savca.co.za',
    attendees: '800+',
    icon: 'pie-chart',
  },
  {
    ...
    contactEmail: 'info@sareit.com',
    speakerEmail: 'speakers@sareit.com',
    attendees: '500+',
    icon: 'home',
  },
  {
    ...
    contactEmail: 'info@api-summit.com',
    speakerEmail: 'speakers@api-summit.com',
    attendees: '400+',
    icon: 'map-pin',
  },
  {
    ...
    contactEmail: 'info@startupmapafrica.com',
    speakerEmail: 'speakers@startupmapafrica.com',
    attendees: '500+',
    icon: 'pie-chart',
  },
  ...
  // --- FINTECH ---
  {
    ...
    contactEmail: 'info@fintechsummit.co.za',
    speakerEmail: 'speakers@fintechsummit.co.za',
    attendees: '1,000+',
    icon: 'credit-card',
  },
  {
    ...
    contactEmail: 'info@fintechnews.africa',
    speakerEmail: 'speakers@fintechnews.africa',
    attendees: '500+',
    icon: 'repeat',
  },
  {
    ...
    contactEmail: 'info@seamlessafrica.com',
    speakerEmail: 'speakers@seamlessafrica.com',
    attendees: '2,000+',
    icon: 'layers',
  },
  {
    ...
    contactEmail: 'info@bfsiitsummit.com',
    speakerEmail: 'speakers@bfsiitsummit.com',
    attendees: '200+',
    icon: 'database',
  },
  {
    ...
    contactEmail: 'info@blockchainafrica.co',
    speakerEmail: 'speakers@blockchainafrica.co',
    attendees: '1,500+',
    icon: 'link-2',
  },
  ...
  // --- INFRASTRUCTURE ---
  {
    ...
    contactEmail: 'info@infrastructure-africa.com',
    speakerEmail: 'speakers@infrastructure-africa.com',
    attendees: '1,000+',
    icon: 'tool',
  },
  {
    ...
    contactEmail: 'info@big5constructsouthafrica.com',
    speakerEmail: 'speakers@big5constructsouthafrica.com',
    attendees: '9,000+',
    icon: 'tool',
  },
  {
    ...
    contactEmail: 'info@southafricainfrastructureexpo.com',
    speakerEmail: 'speakers@southafricainfrastructureexpo.com',
    attendees: '2,000+',
    icon: 'layers',
  },
  {
    ...
    contactEmail: 'info@resideconference.co.za',
    speakerEmail: 'speakers@resideconference.co.za',
    attendees: '800+',
    icon: 'home',
  },
  ...
  // --- ENERGY & MINING ---
  {
    ...
    contactEmail: 'info@africaenergyindaba.com',
    speakerEmail: 'speakers@africaenergyindaba.com',
    attendees: '5,000+',
    icon: 'zap',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@solarpowerafrica.com',
    speakerEmail: 'speakers@solarpowerafrica.com',
    attendees: '3,000+',
    icon: 'sun',
    delegateInfo: {
  ...
  },
  {
    ...
    contactEmail: 'info@aecweek.com',
    speakerEmail: 'speakers@aecweek.com',
    attendees: '6,800+',
    icon: 'battery-charging',
  },
  {
    ...
    contactEmail: 'info@african-miningweek.com',
    speakerEmail: 'speakers@african-miningweek.com',
    attendees: '2,000+',
    icon: 'layers',
  },
  {
    ...
    contactEmail: 'info@electramining.co.za',
    speakerEmail: 'speakers@electramining.co.za',
    attendees: '30,000+',
    icon: 'truck',
  },
  {
    ...
    contactEmail: 'info@impc2026.com',
    speakerEmail: 'speakers@impc2026.com',
    attendees: '2,000+',
    icon: 'hexagon',
  },
  {
  ...
  // --- ENTREPRENEURSHIP ---
  {
    name: 'Proudly Buy Local Summit & Expo 2026',
    focus: 'Entrepreneurship',
    date: 'Mar 16-17, 2026',
    location: 'Sandton Convention Centre, Johannesburg',
    country: 'South Africa',
    description: "14th edition of Proudly South African's flagship event. Theme: 'Localisation...A critical imperative to the economy.' Premier buy local procurement event attracting senior government officials, captains of industry, financiers, innovators, entrepreneurs, organised labour, and over 200 local exhibitors. Includes MSME workshops, business matchmaking seminars and market access opportunities.",
    website: 'https://proudlysa.co.za/buy-local-summit-2026/',
    contactEmail: 'info@proudlysa.co.za',
    speakerEmail: 'speakers@proudlysa.co.za',
    attendees: '2,000+',
    icon: 'shopping-cart',
  },
  {
    ...
    contactEmail: 'info@durbanbusinessfair.co.za',
    speakerEmail: 'speakers@durbanbusinessfair.co.za',
    attendees: '2,000+',
    icon: 'shopping-bag',
  },
  {
    ...
    contactEmail: 'info@capetownbusinesssummit.co.za',
    speakerEmail: 'speakers@capetownbusinesssummit.co.za',
    attendees: '2,000+',
    icon: 'briefcase',
  },
  {
    ...
    contactEmail: 'info@fasa.co.za',
    speakerEmail: 'speakers@fasa.co.za',
    attendees: '1,000+',
    icon: 'shopping-bag',
  },
  {
    ...
    speakerEmail: 'speakers@cut.ac.za',
    attendees: '500+',
    icon: 'users',
  },
  {
    ...
    contactEmail: 'info@trigaventures.org',
    speakerEmail: 'speakers@trigaventures.org',
    attendees: '300+',
    icon: 'award',
  },
  {
    name: 'Forbes Woman Africa Leading Women Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Mar 18, 2026',
    location: 'Sandton Convention Centre, Johannesburg',
    country: 'South Africa',
    description: "A powerful gathering of influential female leaders from business, politics, art, sports and civil society. The who's who of female leadership on the continent and beyond  trailblazers who are distinct in their thinking but single-minded in purpose for a new, equal and thriving world.",
    website: 'https://www.cnbcafrica.com/events/forbes-woman-africa-leading-women-summit-2026',
    contactEmail: 'info@cnbcafrica.com',
    speakerEmail: 'speakers@cnbcafrica.com',
    attendees: '1,500+',
    icon: 'award',
  },
  {
    name: 'SA Innovation Week 2026',
    focus: 'Technology',
    date: 'Mar 16-20, 2026',
    location: 'Nasrec Expo Centre, Johannesburg',
    country: 'South Africa',
    description: "Inaugural SA Innovation Week hosted by the Technology Innovation Agency (TIA) and SA Innovation Summit (SAIS). Nationwide innovation showcases on 16-17 March followed by a three-day innovation festival at Nasrec (18-20 March). A nationally coordinated effort to celebrate and accelerate South Africa's innovation ecosystem.",
    website: 'https://innovationweek.co.za',
    contactEmail: 'info@innovationweek.co.za',
    speakerEmail: 'speakers@innovationweek.co.za',
    attendees: '3,000+',
    icon: 'zap',
  },
  {
    name: 'Branding Masterclass with Sheldon Tatchell',
    focus: 'Entrepreneurship',
    date: 'Mar 20, 2026',
    location: 'JCC House, Johannesburg',
    country: 'South Africa',
    description: "An intimate branding masterclass led by Sheldon Tatchell, founder of Legends Barbershop and serial entrepreneur. Learn the art of building a brand from scratch, franchising, and scaling your business identity. Perfect for aspiring entrepreneurs and emerging brands looking to elevate their market presence.",
    website: 'https://legendsbarbershop.co.za',
    contactEmail: 'info@legendsbarbershop.co.za',
    speakerEmail: 'speakers@legendsbarbershop.co.za',
    attendees: '200+',
    icon: 'edit',
  },
  {
    name: 'Kasi Tech Series 2026',
    focus: 'Technology',
    date: 'Mar 25, 2026',
    location: 'Soweto, Johannesburg',
    country: 'South Africa',
    description: "The first-ever Kasi Tech Series powered by Bulelani Balabala's TEA (Technology, Entrepreneurship, Africa). Bringing tech innovation directly to the townships, connecting local entrepreneurs with digital tools, mentorship and funding opportunities. Bridging the digital divide in South Africa's kasi communities.",
    website: 'https://techdailypost.co.za',
    contactEmail: 'info@techdailypost.co.za',
    speakerEmail: 'speakers@techdailypost.co.za',
    attendees: '500+',
    icon: 'smartphone',
  },
  {
    name: 'BRICS Youth Innovation Summit 2026',
    focus: 'Technology',
    date: 'Apr 9-10, 2026',
    location: 'Johannesburg',
    country: 'South Africa',
    description: "4th BRICS+ Youth Innovation Summit under the theme 'Harnessing youth innovation for sustainable development and global prosperity.' Empowering the next generation of innovators to address global challenges through collaborative, technology-driven solutions promoting sustainability and social equity among BRICS nations and the broader Global South.",
    website: 'https://sabya.co.za/event/4th-brics-youth-innovation-summit-2026/',
    contactEmail: 'info@sabya.co.za',
    speakerEmail: 'speakers@sabya.co.za',
    attendees: '1,000+',
    icon: 'globe',
  },
  {
    name: 'Business to Brand Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Apr 16-17, 2026',
    location: 'Sandton, Johannesburg',
    country: 'South Africa',
    description: "Two-day summit by Pat on Brands for young and building brands. Covering brand strategy, storytelling, digital marketing, packaging design and scaling your business into a recognizable brand. Early bird passes available. Perfect for SMEs and emerging entrepreneurs.",
    website: 'https://patonbrands.com/eventer/business-to-brand-summit/',
    contactEmail: 'info@patonbrands.com',
    speakerEmail: 'speakers@patonbrands.com',
    attendees: '500+',
    icon: 'award',
    delegateInfo: {
      delegateFee: 'From R1,320',
      delegateTypes: ['One Day Pass', 'Two Day Pass', 'SME/Emerging Brands Day Two Pass'],
      includes: ['Conference sessions', 'Networking', 'Brand workshops', 'Refreshments'],
    },
  },
  {
    name: 'House of Beauty 2026',
    focus: 'Entrepreneurship',
    date: 'Apr 24-26, 2026',
    location: 'Kyalami Grand Prix Circuit, Midrand',
    country: 'South Africa',
    description: "South Africa's premier beauty industry expo at the iconic Kyalami Grand Prix Circuit. Showcasing the latest in beauty, skincare, haircare, cosmetics, wellness and personal care. Connecting beauty entrepreneurs, brands, distributors and consumers for three days of exhibits, masterclasses and networking.",
    website: 'https://houseofbeauty.co.za',
    contactEmail: 'info@houseofbeauty.co.za',
    speakerEmail: 'speakers@houseofbeauty.co.za',
    attendees: '5,000+',
    icon: 'star',
  },
  {
    name: 'Tender Success Summit 2026',
    focus: 'Entrepreneurship',
    date: 'May 28, 2026',
    location: 'Focus Rooms, Modderfontein, Johannesburg',
    country: 'South Africa',
    description: "A national platform for supplier growth powered by ROI Group. Convening entrepreneurs, corporates, financiers, government and tech leaders to strengthen South Africa's supplier economy. Operating at the intersection of procurement, enterprise development, market access, finance and digital transformation. Breaking SME barriers from compliance to real market participation.",
    website: 'https://tendersuccess.co.za',
    contactEmail: 'info@tendersuccess.co.za',
    speakerEmail: 'speakers@tendersuccess.co.za',
    attendees: '500+',
    icon: 'briefcase',
  },
  {
    name: 'SME Funding Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Jun 11, 2026',
    location: 'The Empire, Parktown, Johannesburg',
    country: 'South Africa',
    description: "SME South Africa's premier business funding event. The 2nd edition dedicated to empowering small and medium enterprises with insights, tools and connections to secure funding and scale successfully. Expert-led sessions on business finance, investor readiness, access to capital, pitch workshops and one-on-one funder meetings.",
    website: 'https://smesouthafrica.co.za',
    contactEmail: 'info@smesouthafrica.co.za',
    speakerEmail: 'speakers@smesouthafrica.co.za',
    attendees: '500+',
    icon: 'dollar-sign',
    delegateInfo: {
      delegateFee: 'From R999.99',
      delegateTypes: ['General Admission', 'VIP'],
      includes: ['Expert sessions', 'One-on-one funder meetings', 'Networking', 'Pitch workshops'],
    },
  },
  {
    name: 'Youth World Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Jun 11-14, 2026',
    location: 'Paris, France',
    country: 'Pan-African',
    description: "A global gathering of young leaders, students and professionals organized by the Center for International Policy and Sustainability (CIPS). Fully funded and partially funded seats available. Connecting youth from around the world to drive sustainable development, innovation and cross-border collaboration.",
    website: 'https://thecips.org/fully-funded-paritally-funded-application-yws-2026/',
    contactEmail: 'info@thecips.org',
    speakerEmail: 'speakers@thecips.org',
    attendees: '1,000+',
    icon: 'users',
  },
  {
    ...
    country: 'South Africa',
    description: 'Global business and entrepreneurship conference connecting African entrepreneurs with international opportunities.',
    attendees: '2,000+',
    icon: 'globe',
    website: 'https://www.gecafrica.com',
    contactEmail: 'info@gecafrica.com',
    speakerEmail: 'speakers@gecafrica.com',
  },
  {
    name: 'Vaal EmpowaYouth Week',
    focus: 'Entrepreneurship',
    date: 'Apr 20-24, 2026',
    location: 'Vaal, South Africa',
    country: 'South Africa',
    description: 'A week-long youth empowerment initiative focused on entrepreneurship, skills development, and economic participation for young people in the Vaal region. Features workshops, mentorship, and business pitch competitions.',
    attendees: '1,500+',
    icon: '=�',
    website: 'https://www.empowayouth.co.za',
    contactEmail: 'info@empowayouth.co.za',
    speakerEmail: 'speakers@empowayouth.co.za',
  },
  {
    ...
    country: 'South Africa',
    description: 'A sustainability-focused youth gathering addressing climate change, green jobs, and environmental entrepreneurship. Brings together young leaders, innovators, and changemakers to create impact-driven solutions.',
    attendees: '1,200+',
    icon: '<1',
    website: 'https://www.greenyouthindaba.co.za',
    contactEmail: 'info@greenyouthindaba.co.za',
    speakerEmail: 'speakers@greenyouthindaba.co.za',
  },
  {
    name: 'Smart Procurement World Indaba 2026',
    focus: 'Entrepreneurship',
    date: 'Sep 14-17, 2026',
    location: 'Gallagher Convention Centre, Midrand',
    country: 'South Africa',
    description: "SA's largest procurement and inbound supply chain indaba. Premier networking event for public and private sector procurement and supply chain professionals. Features the Leaders Forum, Public Sector Supply Chain Summit, Sustainability Summit Africa, Corporate Exhibition, SMME Conference and Visitor Open Day. Low-risk, cost-effective route to increased private sector and government business.",
    website: 'https://smartprocurementworld.com/indaba',
    contactEmail: 'info@smartprocurementworld.com',
    speakerEmail: 'speakers@smartprocurementworld.com',
    attendees: '5,000+',
    icon: 'briefcase',
    delegateInfo: {
      delegateFee: 'From R3,000',
      delegateTypes: ['Delegate', 'Sponsor', 'Exhibitor', 'SMME Delegate', 'SMME Exhibitor', 'Media'],
      includes: ['4-day conference access', 'Exhibition floor', 'Networking events', 'SMME workshops'],
    },
  },
  {
    name: 'Township Economy Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Nov 20-21, 2026',
    location: 'Hospital View Park, Tembisa, Ekurhuleni',
    country: 'South Africa',
    description: "8th annual gathering of township entrepreneurs. The premier event for township entrepreneurs, corporate South Africa and government to connect. Over 1,000 innovative township business owners. Focused on Spaza Shop & Distribution, Kasi Tech & Digital Transformation, Green Economy, Backroom & Property Market, Manufacturing, and Mobility & Logistics eKasi.",
    website: 'https://townshipeconomysummit.co.za',
    contactEmail: 'info@townshipeconomysummit.co.za',
    speakerEmail: 'speakers@townshipeconomysummit.co.za',
    attendees: '1,000+',
    icon: 'users',
  },
  {
    name: 'Manufacturing Indaba & Township Economies Expo 2026',
    focus: 'Entrepreneurship',
    date: 'Jul 15-16, 2026',
    location: 'Sandton Convention Centre, Johannesburg',
    country: 'South Africa',
    description: "Connecting i-Kasi with Corporate  Empowering Township Industrialists. The Township Economies Expo co-locates with the Manufacturing Indaba to bridge the gap between corporate manufacturing giants and township-based industrialists. Enabling township businesses to scale, access formal markets, and build resilience while strengthening supply chains.",
    website: 'https://townshipeconomies.co.za',
    contactEmail: 'info@townshipeconomies.co.za',
    speakerEmail: 'speakers@townshipeconomies.co.za',
    attendees: '2,000+',
    icon: 'tool',
  },
  {
    name: 'Absa-SACCI National MSME Summit 2026',
    focus: 'Entrepreneurship',
    date: 'Jun 2026',
    location: 'Johannesburg',
    country: 'South Africa',
    description: "National MSME Summit focusing on township economy and development. Strengthens connections between SMMEs, academia and larger institutions. Highlights development potential within township economies and encourages investments into regional economies. Networking with industry leaders and actionable insights for business growth.",
    website: 'https://www.absasaccimsmesummit.co.za',
    contactEmail: 'info@absasaccimsmesummit.co.za',
    speakerEmail: 'speakers@absasaccimsmesummit.co.za',
    attendees: '500+',
    icon: 'briefcase',
  },
];
...
export const AFRICA_CONFERENCES: Conference[] = [
  // --- KENYA ---
  {
    ...
    contactEmail: 'info@africatechsummit.com',
    speakerEmail: 'speakers@africatechsummit.com',
    attendees: '2,000+',
    icon: 'globe',
  },
  {
    ...
    contactEmail: 'info@aieverythingkenya.com',
    speakerEmail: 'speakers@aieverythingkenya.com',
    attendees: '15,000+',
    icon: 'cpu',
  },
  {
    ...
    contactEmail: 'info@sankalpforum.com',
    speakerEmail: 'speakers@sankalpforum.com',
    attendees: '1,000+',
    icon: 'target',
  },
  {
    ...
    contactEmail: 'info@avca-africa.org',
    speakerEmail: 'speakers@avca-africa.org',
    attendees: '800+',
    icon: 'trending-up',
  },
  {
    ...
    contactEmail: 'info@africafintechlive.com',
    speakerEmail: 'speakers@africafintechlive.com',
    attendees: '1,500+',
    icon: 'credit-card',
  },
  {
    ...
    contactEmail: 'info@investafrica.com',
    speakerEmail: 'speakers@investafrica.com',
    attendees: '1,500+',
    icon: 'dollar-sign',
  },
  {
    ...
    contactEmail: 'info@kpmg.com',
    speakerEmail: 'speakers@kpmg.com',
    attendees: '250+',
    icon: 'briefcase',
  },
  {
    ...
    contactEmail: 'info@eabc-online.com',
    speakerEmail: 'speakers@eabc-online.com',
    attendees: '500+',
    icon: 'globe',
  },
  {
    ...
    contactEmail: 'info@seamlesseastafrica.com',
    speakerEmail: 'speakers@seamlesseastafrica.com',
    attendees: '2,000+',
    icon: 'repeat',
  },
  {
    ...
    contactEmail: 'info@big5constructkenya.com',
    speakerEmail: 'speakers@big5constructkenya.com',
    attendees: '3,000+',
    icon: 'tool',
  },
  {
  ...
  // --- MOROCCO ---
  {
    ...
    contactEmail: 'info@gitexafrica.com',
    speakerEmail: 'speakers@gitexafrica.com',
    attendees: '55,000+',
    icon: 'globe',
    delegateInfo: {
  ...
  },
  {
    ...
    contactEmail: 'info@seamlessnorthafrica.com',
    speakerEmail: 'speakers@seamlessnorthafrica.com',
    attendees: '2,000+',
    icon: 'layers',
  },
  ...
  },
  {
    ...
    contactEmail: 'info@westafricainfrastructureexpo.com',
    speakerEmail: 'speakers@westafricainfrastructureexpo.com',
    attendees: '2,000+',
    icon: 'tool',
  },
  {
    ...
    contactEmail: 'info@big5constructnigeria.com',
    speakerEmail: 'speakers@big5constructnigeria.com',
    attendees: '5,000+',
    icon: 'tool',
  },
  {
    ...
    contactEmail: 'info@regtechafrica.com',
    speakerEmail: 'speakers@regtechafrica.com',
    attendees: '2,000+',
    icon: 'shield',
  },
  {
    ...
    contactEmail: 'info@aerowestafrica.com',
    speakerEmail: 'speakers@aerowestafrica.com',
    attendees: '500+',
    icon: 'navigation',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@theafricaceoforum.com',
    speakerEmail: 'speakers@theafricaceoforum.com',
    attendees: '2,000+',
    icon: 'award',
  },
  {
    ...
    contactEmail: 'info@africafintechsummit.com',
    speakerEmail: 'speakers@africafintechsummit.com',
    attendees: '500+',
    icon: 'smartphone',
  },
  {
    ...
    contactEmail: 'info@transformafricasummit.org',
    speakerEmail: 'speakers@transformafricasummit.org',
    attendees: '3,000+',
    icon: 'globe',
  },
  ...
  // --- ETHIOPIA ---
  {
    ...
    contactEmail: 'info@uneca.org',
    speakerEmail: 'speakers@uneca.org',
    attendees: '1,500+',
    icon: 'briefcase',
  },
  {
    ...
    contactEmail: 'info@eastafricainfrastructureexpo.com',
    speakerEmail: 'speakers@eastafricainfrastructureexpo.com',
    attendees: '2,000+',
    icon: 'tool',
  },
  {
    ...
    contactEmail: 'info@big5constructethiopia.com',
    speakerEmail: 'speakers@big5constructethiopia.com',
    attendees: '3,000+',
    icon: 'tool',
  },
  ...
  // --- EGYPT ---
  {
    ...
    contactEmail: 'info@aieverything.com',
    speakerEmail: 'speakers@aieverything.com',
    attendees: '5,000+',
    icon: 'cpu',
  },
  {
    ...
    contactEmail: 'info@riseupsummit.com',
    speakerEmail: 'speakers@riseupsummit.com',
    attendees: '8,000+',
    icon: 'trending-up',
  },
  {
    ...
    contactEmail: 'info@big5constructegypt.com',
    speakerEmail: 'speakers@big5constructegypt.com',
    attendees: '5,000+',
    icon: 'tool',
  },
  ...
  // --- GHANA ---
  {
    ...
    contactEmail: 'info@elearning-africa.com',
    speakerEmail: 'speakers@elearning-africa.com',
    attendees: '2,000+',
    icon: 'book',
  },
  {
    ...
    contactEmail: 'info@dasummitafrica.com',
    speakerEmail: 'speakers@dasummitafrica.com',
    attendees: '500+',
    icon: 'dollar-sign',
  },
  {
    ...
    contactEmail: 'info@panafricanaisummit.com',
    speakerEmail: 'speakers@panafricanaisummit.com',
    attendees: '1,000+',
    icon: 'cpu',
  },
  {
    ...
    contactEmail: 'info@au-afcfta.org',
    speakerEmail: 'speakers@au-afcfta.org',
    attendees: '2,000+',
    icon: 'globe',
  },
  ...
  // --- COTE D\'IVOIRE ---
  {
    ...
    contactEmail: 'info@ec.europa.eu',
    speakerEmail: 'speakers@ec.europa.eu',
    attendees: '500+',
    icon: 'truck',
  },
  ...
  // --- UGANDA ---
  {
    ...
    contactEmail: 'info@investafricasummit.com',
    speakerEmail: 'speakers@investafricasummit.com',
    attendees: '1,000+',
    icon: 'dollar-sign',
  },
  ...
  // --- SENEGAL ---
  {
    ...
    contactEmail: 'info@dakarbitcoindays.com',
    speakerEmail: 'speakers@dakarbitcoindays.com',
    attendees: '500+',
    icon: 'link',
  },
  ...
  // --- BURKINA FASO ---
  {
    ...
    contactEmail: 'info@africatek.eai-conferences.org',
    speakerEmail: 'speakers@africatek.eai-conferences.org',
    attendees: '300+',
    icon: 'cpu',
  },
  ...
  // --- NAMIBIA ---
  {
    ...
    contactEmail: 'info@nipdb.com',
    speakerEmail: 'speakers@nipdb.com',
    attendees: '500+',
    icon: 'dollar-sign',
  },
  ...
  // --- BOTSWANA ---
  {
    name: 'IDEAL Summit 2026',
    focus: 'Investment',
    date: 'Apr 8-9, 2026',
    location: 'Royal Aria Conference Centre, Tlokweng',
    country: 'Botswana',
    description: 'IDEAL Summit 2026 brings together institutional investors, development finance institutions, strategic corporates and entrepreneurs seeking investment for African projects. Day 1 (April 8) is an invitation-only Investor Roundtable, Day 2 (April 9) is the public summit. IDEAL stands for Inclusion, Diversity, Equity, Access and Local Empowerment. This platform matches credible projects with serious investors looking to deploy capital across Africa.',
    website: 'https://idealsummit.co.bw',
    contactEmail: 'info@idealsummit.co.bw',
    speakerEmail: 'speakers@idealsummit.co.bw',
    attendees: '300+',
    icon: 'briefcase',
    delegateInfo: {
      delegateFee: 'By Invitation (Day 1) / Registration (Day 2)',
      delegateTypes: ['Investor', 'Entrepreneur', 'DFI Representative', 'Corporate'],
      includes: ['Summit access', 'Investor introductions', 'Networking sessions', 'Project showcases'],
    },
  },
  {
    ...
    contactEmail: 'info@bih.co.bw',
    speakerEmail: 'speakers@bih.co.bw',
    attendees: '500+',
    icon: 'star',
  },
  ...
  // --- TUNISIA ---
  {
    ...
    contactEmail: 'info@tunisiadigitalsummit.com',
    speakerEmail: 'speakers@tunisiadigitalsummit.com',
    attendees: '1,000+',
    icon: 'monitor',
  },
  {
  ...
  // --- PAN-AFRICAN ---
  {
    ...
    contactEmail: 'info@aiforpeaceafrica.com',
    speakerEmail: 'speakers@aiforpeaceafrica.com',
    attendees: '500+',
    icon: 'shield',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@afrilabs.com',
    speakerEmail: 'speakers@afrilabs.com',
    attendees: '1,000+',
    icon: 'grid',
  },
  {
    ...
    contactEmail: 'info@afdb.org',
    speakerEmail: 'speakers@afdb.org',
    attendees: '3,000+',
    icon: 'dollar-sign',
  },
  {
    ...
    contactEmail: 'info@africainvestmentforum.com',
    speakerEmail: 'speakers@africainvestmentforum.com',
    attendees: '2,000+',
    icon: 'trending-up',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@internetsummit.africa',
    speakerEmail: 'speakers@internetsummit.africa',
    attendees: '500+',
    icon: 'wifi',
  },
  ...
  },
  {
    ...
    contactEmail: 'info@rubyconf.africa',
    speakerEmail: 'speakers@rubyconf.africa',
    attendees: '500+',
    icon: 'code',
  },
  {
  ...
  },
  {
    ...
    contactEmail: 'info@awief.org',
    speakerEmail: 'speakers@awief.org',
    attendees: '1,500+',
    icon: 'users',
  },
  {
    ...
    contactEmail: 'info@africarena.com',
    speakerEmail: 'speakers@africarena.com',
    attendees: '1,500+',
    icon: 'trophy',
  },
  {
  ...
  // --- GOVTECH ---
  {
    ...
    contactEmail: 'info@govtech.gov.za',
    speakerEmail: 'speakers@govtech.gov.za',
    attendees: '3,000+',
    icon: 'flag',
  },
  {
